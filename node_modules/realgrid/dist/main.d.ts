...
/**
 * shadow그리드의 편집기가 종료된후 호출되는 콜백
 *
 * [매개변수]
 *
 * `grid` - gridView
 *
 * `index` 편집한 셀의 CellIndex
 */
declare type AfterCallback = (grid: GridBase, index: CellIndex) => void;

/**
 * 숫자 형 컬럼 셀의 값을 바로 표시하는 렌더러
 *
 * @remarks
 * [상위 클래스]
 *
...
/**
 * shadow그리드의 편집기가 표시되기전에 호출되는 콜백
 *
 * [매개변수]
 *
 * `grid` - gridView
 *
 * `index` - 편집할 셀의 CellIndex
 *
 * [반환값] - `false`를 return하면 shadow그리드의 편집기가 표시되지 않는다.
 *
 */
declare type BeforeCallback = (grid: GridBase, index: CellIndex) => boolean;
 ...
 * ```
 */
export declare type BooleanOutputCallback = (ds: DataSource, row: number, field: string, value: any) => boolean;
...
export declare interface ButtonCellRenderer extends CellRenderer {
     ...
     *
     * @remarks
     * true이면 스페이스바를 입력했을때 버튼 click을 실행한다.
     *
     * @defaultValue `true`
     */
    spaceKey?: boolean;
...
/**
 * rowGroup일때 컬럼 groupFooter에 표시되는 값을 사용자가 지정할때 사용되는 콜백의 형식
 *
 * @remarks
 * [매개변수 목록]
 *
 ...
 * `column` - footer의 컬럼
 *
 * `footerIndex` - Group의 footer가 여러개인경우 순번
 *
 * `model` - GroupItem
 *
 ...
 * [반환값] - 화면에 표시될 내용.
 */
export declare type ColumnGroupSummaryCallback = (grid: GridBase, column: DataColumn, footerIndex: number, model: any, value: any) => void;
...
export declare interface ColumnSummary extends ColumnObject {
     ...
     */
    valueCallback: ColumnSummaryCallback | ColumnGroupSummaryCallback;
    /**
     * 화면에 표시되는 텍스트
     *
     * @remarks
 ...
 *
 * `summary` - footer 또는 summary 객체
 *
 * `value` - expression이 지정된 경우 값
 *
 * [반환값] - 화면에 표시될 내용.
 */
declare type ColumnSummaryCallback = (grid: GridBase, column: DataColumn, footerIndex: number, summary: ColumnSummary, value: any) => any;
 ...
 *
 */
export declare type CompareCallback = (v1: string, v2: string, sensitive: boolean, partialMatch: boolean) => boolean;
 ...
 * ```
 */
declare type CopyTextCallback = (grid: GridBase, itemIndex: number, column: ValueColumn, value: any) => string;
 ...
 * ```
 */
export declare type CreateFooterCallback = (owner: any, group: GroupItem, footerIndex: number) => boolean;
...
export declare interface DataColumn extends ValueColumn {
     ...
     */
    addFilters(filters: (ColumnFilter | ConfigObject)[], overwrite: boolean): void;
    /**
 ...
 * ```
 */
export declare type DataDragCallback = (source: GridBase, sourceItems: number[], target: GridBase, targetItem: number) => boolean;
 ...
 * ```
 */
export declare type DataDragLabelCallback = (source: GridBase, sourceItems: number[], target: GridBase, targetItem: number) => string;
 ...
 * ```
 */
export declare type DataDropCallback = (source: GridBase, sourceItems: number[], target: GridBase, targetItem: number) => void;
 ...
 */
export declare interface DataExportOptions extends ExportBaseOptions {
    /**
    ...
    lfText?: string;
    /**
     * cr(Carriage Return)가 있는 경우 치환할 문자열을 지정한다.
     *
     * @defaultValue `null`
     */
    crText?: string;
...
export declare abstract class DataProviderBase {
     ...
     *
     * @param row - 행 고유번호
     * @param rowState - `true`이면 결과값에 행상태값을 추가한다.
     *
     * @example
     * ```js
...
export declare interface DateCellEditor extends TextCellEditor {
     ...
     *
     * @remarks
     * 키보드로 minDate 보다 이후 날짜가 입력되면, maxDate 로 변경된다.
     *
     * @defaultValue `new Date(2100, 11, 31)`
     */
    maxDate?: string | Date;
 ...
 * ```
 */
export declare type DatetimeOutputCallback = (ds: DataSource, row: number, field: string, value: any) => Date;
 ...
 * ```
 */
export declare type DropFieldMapCallback = (source: GridBase, sourceItems: number[], target: GridBase, targetItem: number) => FieldMap;
 ...
 *
 * @remarks
 * {@link GridExportOptions."type"} 에서 사용된다.
 */
 ...
 * ```
 */
export declare type FieldValueCallback = (ds: DataSource, rowId: number, fieldName: string, fields: string[], values: any[]) => any;
 ...
 * ```
 */
export declare type FilterCallback = (ds: DataSource, dataRow: number, level: number, field: number, filter: ColumnFilter, value: any) => boolean;
...
export declare abstract class GridBase {
    ...
    constructor(container: string | HTMLDivElement, accessibility?: boolean, shadowOptions?: ShadowDomOptions);
     ...
     *
     * @remarks
     * 이 이벤트 내에서 클릭을 처리했다면 반드시 `true`를 리턴해야 element의 기본 동작을 실행하지 않는다.
     *
     * [매개변수 목록]
     *
     * `grid` - GridBase 컨트롤
     ...
     * ```
     */
    setFooters(value: GridFooterCollection): void;
    /**
     ...
     * ```
     */
    setHeaderSummaries(value: HeaderSummaryCollection): void;
    /**
     * 셀 스타일을 변경한다.
     *
     * @remarks
...
export declare interface GridColumn {
     ...
     * ```
     */
    setGroupFooters(footers: any[]): void;
    /**
 ...
 * {@link ExportBaseOptions}
 */
export declare interface GridExportOptions extends ExportBaseOptions {
    /**
     * 내보내기 시 엑셀 문서의 제목
     */
 ...
 * ```
 */
export declare interface GridFooter {
    /**
     * 스타일 클래스 이름
     */
    styleName?: string;
 ...
 * ```
 */
export declare interface HeaderSummary {
    /**
     * 스타일 클래스 이름
     */
    styleName?: string;
...
export declare interface HeaderSummaryCollection {
     ...
     */
    get(index: number): HeaderSummary;
    /**
     ...
     * @param index - 보여지는 순서 `0`부터 시작한다.
     */
    getVisible(index: number): HeaderSummary;
}
...
export declare interface IconCellRenderer extends CellRenderer {
     ...
     *
     * @remarks
     * {@link IconCellRenderer.iconCallback} 이 할당되어 있지 않거나 `false`를 반환한 경우 적용된다.
     *
     *
     * @example
     * ```js
...
export declare interface ImageCellRenderer extends CellRenderer {
     ...
     *
     * @remarks
     * {@link ImageCellRenderer.imageCallback} 이 할당되어 있지 않거나 `false`를 반환한 경우 적용된다.
     *
     *
     * @example
     * ```js
...
/**
 * 사용할 이미지 경로의 목록을 저장하기 위한 객체를 생성하기 위한 클래스
 *
 * @remarks
 * 실제 이미지파일이 위치한 경로를 보관한다.
 * `RealGrid.ImageList()`로 생성자를 호출할 수 있다.
 */
export declare class ImageList {
    ...
    /**
     * 이미지 경로들을 추가한다.
     * @param urls - url 주소의 배열
     */
    addUrls(...urls: string[]): void;
    /**
     * 이미지 경로를 반환한다.
     * @param index - 경로를 반환할 이미지의 인덱스
     */
...
export declare class LocalDataProvider extends DataProviderBase {
     ...
     * @param strict - 값이 undefined이거나 명시되지 않은 필드는 기존의 값을 유지한다
     * @param rowEvents - 이벤트를 일괄 발생할지의 여부, 기본값: `false`
     * @example
     * ```js
     ...
     * @param rowState - `true`이면 결과 값에 행상태값을 추가한다.
     *
     * @example
     * ```js
...
export declare class LocalTreeDataProvider extends DataProviderBase {
     ...
     * ```
     */
    getJsonRow(row: number, rowState: boolean): any;
    /**
    ...
    /**
     * 같은 부모의 형제 사이에서 특정 데이터행들의 위치를 지정한 단계만큼 이동한다.
     *
     * @param row - 데이터 행의 트리 id
     * @param count - 이동할 데이터 갯수
     * @param offset - 지정 단계 값
     * @returns 해당 데이터 행이 존재하지 않을 경우 `false`를 반환한다
     *
     * @example
     * ```js
     * dataProvider.moveRowsSibling(0, 3, 1);
     * ```
     */
    moveRowsSibling(row: number, offset: number): boolean;
    /**
 ...
 * ```
 */
export declare type MenuItemClick = (grid: GridBase, menuItem: MenuItem, clickData: ClickData) => void;
 ...
 * ```
 */
export declare type NumberOutputCallback = (ds: DataSource, row: number, field: string, value: any) => number;
 ...
 * ```
 */
export declare interface PopupMenuItem {
    /**
...
declare class RealGrid {
    ...
    static exportGrid(options: GridExportOptions): void;
    static setDebug(trace: boolean, debug: boolean, key: boolean): void;
    static setMobile(value: boolean): void;
    static get ImageList(): typeof ImageList;
    ...
    static get ValueType(): typeof ValueType;
}
 ...
 * [반환값] - string type 의 template 형식
 */
export declare type RealizeFormValueCallback = (form: FormView, item: FormValueItem, field: string) => string;
...
declare type RowBarCellStyleCallback = (grid: GridBase, type: string, index: number) => string;
 ...
 * ```
 */
declare interface RowStyleObject {
    /**
     * 행전체의 editable 여부
     *
     * @remarks
 ...
 *
 * @remarks
 * {@link MobileOptions.scrollOnEditing} 에서 설정 가능하다.
 *
 * @example
 * ```js
 * grid.mobileOptions.scrollOnEditting = 'cancel';
 * ```
 */
...
/**
 * Shadow Dom 에서 {@link CellButton} 을 지칭하는 텍스트
 */
declare interface ShadowCellButtonTexts {
    /**
     * 실행 버튼 텍스트
     */
    action: string;
 ...
 * `grid` - gridView
 *
 * `itemIndex` - 체크값이 변경된 행의 itemIndex
 *
 * `checked` - 선택여부
 *
 */
declare type ShadowCheckItemCallback = (grid: GridBase, itemIndex: number, checkd: boolean) => void;
 ...
 */
export declare interface ShadowDomOptions {
    /**
     * 표시되는 행의 갯수
     */
    count?: number;
     ...
     * @remarks
     * table tag의 caption으로 표시된다.
     * title이 있으면 title다음에 표시
     */
    description?: string;
    /**
     * 그리드에 변경이 있는 경우 자동으로 refresh될것인지 여부
     *
     * @defaultValue `true`
     */
    autoDrawing?: boolean;
    ...
    /**
     * 편집중 다른 셀의 편집버튼이 클릭되었을때 표시되는 메세지
     *
     * @defaultValue `이미 편집중입니다`
     */
    alreadyEditMessage?: string;
    /**
     * shadow그리드의 checkBox가 체크 되었을때 실행되는 callback
     *
     * @remarks
     * 그리드의 onItemChecked와는 별개로 shadow의 check가 변경되었을때 호출된다.
     */
    checkItemCallback?: ShadowCheckItemCallback;
    /**
     * shadow그리드에서 편집버튼을 클릭했을때 실행되는 callback
     *
     * @remarks
     * `false`를 return하면 shadowDom의 기본편집기가 실행되지 않는다.
     */
    beforeEditPopupCallback?: BeforeCallback;
    /**
     * shadowDom그리드의 편집기가 종료된후 호출되는 callback
     */
    afterEditPopupCallback?: AfterCallback;
}

/**
 * Shadow Dom 에서 {@link RowState} 를 지칭하는 텍스트
 */
declare interface ShadowStateTexts {
    /**
     * 생성됨
     */
    created: string;
...
export declare interface SignalBarCellRenderer extends CellRenderer {
     ...
     *
     * 예를 들어, `minimum`이 50, maximum 이 150 이면, 50부터 150 사이의 값이 아니라면 신호 세기가 없는 것으로 간주된다.
     *
     * @defaultValue `NaN`
     */
    minimum?: number;
...
export declare type TreeIconCallback = (tree: TreeView, itemIndex: number, dataRow: number, iconIndex: number) => number | undefined;
 ...
 */
declare type UserFilterAddCallback = (grid: GridBase, column: GridColumn, text: string) => any;
 ...
 * GroupItem
 */
export declare type GroupItem = any;
