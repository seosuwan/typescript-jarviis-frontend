...
declare const visibleSortedGridRowsSelector: reselect.OutputSelector<GridState, Map<GridRowId, {
    [key: string]: any;
}>, (res1: Record<GridRowId, boolean>, res2: Map<GridRowId, {
    [key: string]: any;
}>) => Map<GridRowId, {
    [key: string]: any;
}>>;
declare const visibleSortedGridRowsAsArraySelector: reselect.OutputSelector<GridState, [GridRowId, {
    [key: string]: any;
}][], (res: Map<GridRowId, {
    [key: string]: any;
}>) => [GridRowId, {
...
declare const visibleSortedGridRowIdsSelector: reselect.OutputSelector<GridState, GridRowId[], (res: Map<GridRowId, {
    [key: string]: any;
}>) => GridRowId[]>;
...
declare const unorderedGridRowModelsSelector: reselect.OutputSelector<GridState, {
    [key: string]: any;
}[], (res: GridRowsState) => {
    [key: string]: any;
}[]>;
...
declare const sortedGridRowsSelector: reselect.OutputSelector<GridState, Map<GridRowId, {
    [key: string]: any;
